...
import { InstructionModal } from '../../components/dialogs/instructionModal';
...
interface EmotionPreferenceLayoutProps {

}

const EmotionPreferencesLayout: React.FC<EmotionPreferenceLayoutProps> = () => {
	...
	return (
		<Container>
			<Row>
				{/* <Header title={pageData.page_name} content={pageData.page_instruction} /> */}
			</Row >
...
export default EmotionPreferencesLayout;